...
/**
 * This is fairly low level demo using a RXTXVideoIO directly. The details of this are specific
 * to RS422 devices.
 *
 * @author Brian Schlining
 * @since 2016-02-02T14:56:00
 */
public class ShuttleDemo01 {

    private PrintStream stream;
    private RXTXVideoIO io;

    public ShuttleDemo01(RXTXVideoIO io, PrintStream stream) {
        this.stream = stream;
        this.io = io;
