 ...
 * @since 2015-07-01T14:16:00
 */
public class JavaFXVideoStage extends Stage {
    ...
    public JavaFXVideoStage(String pathToVideo) {
        this(pathToVideo, StageStyle.DECORATED);
    }

    public JavaFXVideoStage(String pathToVideo, StageStyle style) {
        super(style);
